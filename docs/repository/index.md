...
Start here for repository structure and migration decisions.

## Architecture

- [Repository Audit](../architecture/repository-audit.md)
- [Target Repository Structure](../architecture/target-structure.md)

## Migration

- [Standalone Migration Plan](../migration/standalone-migration-plan.md)
...
- [Trust And Evidence Model](../product/trust-evidence-model.md)
- [Product Offer](../product-offer.md)
- [Report Methodology](../report-methodology.md)
- [QA Checklist](../qa-checklist.md)

`docs/product/` is the richer product source-of-truth set. The root-level product offer and methodology files are compact summaries and should be reconciled before they diverge.
